...
public class DemoDataConfiguration {
  ...
  protected void initDemoGroups() {
	...
	String[] assignmentGroups = new String[] {"management", "technical","pmo","rcm"};
  ...
  protected void initDemoUsers() {
    ...
    createUser("fozzie", "Fozzie", "Bear", "fozzie", "fozzie@activiti.org", "org/activiti/rest/images/fozzie.jpg",
	  ...
	  createUser("pmouser", "PMO", "User", "pmouser", "pmouser@in.ibm.com", "org/activiti/rest/images/pmo.jpg",
		        Arrays.asList("pmo","user"), null);
	  createUser("manager", "Management", "User", "manager", "management@in.ibm.com", "org/activiti/rest/images/management.jpg",
		        Arrays.asList("management","user","admin"), null);
	  createUser("techteam", "Technical", "User", "techteam", "techteam@in.ibm.com", "org/activiti/rest/images/technical.jpg",
		        Arrays.asList("technical", "user"), null);
	  createUser("rcmuser", "RCM", "User", "rcmuser", "rcmuser@in.ibm.com", "org/activiti/rest/images/rcm.jpg",
		        Arrays.asList("rcm", "user"), null);
  ...
  protected void initDemoProcessDefinitions() {
    ...
    if (deploymentList == null || deploymentList.size() == 0) {
      /*repositoryService.createDeployment().name(deploymentName)
          ...
          .addClasspathResource("projectonboarding.bpmn.xml")
          .deploy();*/
    	repositoryService.createDeployment().name(deploymentName)
        .addClasspathResource("projectonboarding.bpmn20.xml")
        .deploy();
    }
  }
